...
export default function Page() {
    ...
    const { data, error } = useSWR<Violin[]>(`${process.env.NEXT_PUBLIC_API_BASE_URL}/product/${maker}`, fetcher);
                        ...
                        {filteredViolins.length > 0 ? (
                            ...
                            >
                                {filteredViolins.map((violin) => {
                                    ...
                                    return (
                                        <Link key={violin.id} href={`/products/${violin.makerLast}/${violin.makeYear}`} className="product">
                                            <motion.div
                                            ...
                                            >
                                                ...
                                                <h4 className={"text-gray-500 m-0 p-0"}>{violin.makeYear}</h4>
