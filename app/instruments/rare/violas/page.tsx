    ...
    <div className={"bg-gray-800"}>
      <div className={"flex flex-col text-gray-200"}>
        <Breadcrumbs className={"ml-6"}>
          ...
          >
            <p className={"text-gray-100"}>Violas</p>
          </BreadcrumbItem>
        </Breadcrumbs>
        <div className={"flex flex-col md:flex-row"}>
          ...
          >
            <div>
              <h1 className={"title md:text-center"}>Rare Violas</h1>
            </div>
            <div>
          ...
          <div className={"relative w-full h-80 mt-2 md:w-1/2"}>
            <Image
              ...
              objectFit={"cover"}
              src={
                "https://res.cloudinary.com/dztnyrx5z/image/upload/v1733187974/2_elv7g7.jpg"
              }
              alt={"Rare Violin"}
            />
          </div>
      ...
      <div className="flex flex-row products">
        <InstrumentList category="violas" />
      </div>
    </div>
  );
}
